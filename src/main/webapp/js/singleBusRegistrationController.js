...
$scope.validations=function(obj,val)
{
	...
	if(obj=="plate")
	{
		  if(val!=null && val!="")
		  {
			  if((val.charCodeAt(0)>=48 && val.charCodeAt(0)<=57)) // B01
			  {
	...
	if(($scope.singlebusreg.busname!=null && $scope.singlebusreg.busname!="")&&($scope.singlebusreg.busnumberplate!=null && $scope.singlebusreg.busnumberplate!="")&&($scope.singlebusreg.mobileno!=null)&&($scope.singlebusreg.emailid!=null))
		{
