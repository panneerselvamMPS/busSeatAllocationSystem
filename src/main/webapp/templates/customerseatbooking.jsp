...
<div style="background-color:#e7feff;" class="container">
  ...
  <div ng-show="resplis.length>0">
	   <div data-ng-repeat="m in resplis" style="margin-left:10%">
	    <h1 data-ng-click="expandbus(m,'expand')" class="verticaldtls">{{m.busdetails.busname}} | {{m.startpoint}} to {{m.endpoint}} | {{m.deptime}} - {{m.arrtime}} &nbsp;&nbsp;&nbsp;<i class="fa fa-angle-down" ng-show="!m.expansion"></i><i class="fa fa-angle-up" ng-show="m.expansion"></i></h1>
